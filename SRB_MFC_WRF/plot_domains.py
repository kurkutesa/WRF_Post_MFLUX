# Sopan Kurkute
# Plots High Resolution domain with terrain and watermask and draws a box around the WRF domains.
#
# Udates:
...
#Other directories
HOMEBASE    = '/home/sak298/WRF_MFC_CTRL/data/'
FIG_DIR = '/home/sak298/WRF_water_budget/plots_hrrr/'
...
file_name = '/home/sak298/WRF_MFC_CTRL/geo_em.d02.nc'
...
file_name = '/home/sak298/WRF_MFC_CTRL/geo_em.d01.nc'
hrrr_nc = netcdf.netcdf_file(file_name,'r')
height = hrrr_nc.variables['HGT_M'][0,:,:]
height = height.copy()
ter_lat = hrrr_nc.variables['XLAT_M'][0]
