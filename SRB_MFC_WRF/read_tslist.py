...
def read_tslist(tsfile):
    ...
    Input:
        file: the location of your tslist file (string)
                example: './wrfdir/tslist'
    Output:
...
def main():
    ...
    from BB_cmap import terrain_colormap as tc



    wrf_dir = '/home/sak298/WRF_MFC_CTRL/data/'
    ...
    plt.pcolormesh(wrf_lon,wrf_lat,wrf_ter,
                   ...
                   cmap=tc.terrain_cmap_256())          # Use my custom terrain colormap
